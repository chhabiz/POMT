<%@ Page Title="" Language="C#" MasterPageFile="~/ProgramAdmin/ProgramAdminMaster.master"
    AutoEventWireup="true" CodeBehind="GenerateNewForm.aspx.cs" Inherits="CurriculumMapping.ProgramAdmin.GenerateNewForm" %>

<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="asp" %>
<asp:Content ID="Content2" ContentPlaceHolderID="progadminhead" runat="server">
    <title>Generate New Form - Program Admin</title>
</asp:Content>

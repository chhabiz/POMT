<%@ Page Title="" Language="C#" MasterPageFile="~/ProgramAdmin/ProgramAdminMaster.master"
    AutoEventWireup="true" CodeBehind="MyPendingForms.aspx.cs" Inherits="CurriculumMapping.ProgramAdmin.MyPendingForms" %>

<%@ Register Assembly="Telerik.Web.UI" Namespace="Telerik.Web.UI" TagPrefix="telerik" %>

<asp:Content ID="Content2" ContentPlaceHolderID="progadminhead" runat="server">
    <title>My Forms - Program Admin</title>
</asp:Content>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentMainArea" runat="server">
    <div class="maincontent">
        <div id="textcontent">
            ...
            <telerik:RadListView ID="RadListView1" runat="server" AllowPaging="True" 
                ...
                <ItemTemplate>
                    <tr class="rlvI">
                        ...
                        <td>
                            <asp:HyperLink id="CourseOfferingLink" NavigateUrl='<%# determineURL(Eval("Status.Id"),Eval("CourseOffering.Id"), Eval("CourseOffering.Course.Title"))%>' Target="_self" runat="server" 
                                Text='<%# String.Format("{0}-{1}",Eval("CourseOffering.Course.Code"), Eval("CourseOffering.Course.Title")) %>' />
                        </td>
                        <td>
                            <asp:Label ID="StatusLabel" runat="server" Text='<%# Eval("Status.Statusname") %>' />
                        </td>
                        <td>
                            <asp:Label ID="ActionDateLabel" runat="server" 
                                Text='<%# Eval("ActionDate") %>' />
                        </td>
                        <td>
                        ...
                        <td colspan="5">
                            <table cellspacing="0" class="rlvEditTable">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:TextBox ID="CourseOfferingTextBox" runat="server" CssClass="rlvInput" 
                                            Text='<%# Bind("CourseOffering") %>' />
                                    </td>
                                </tr>
                                <tr>
                                    <td>
            ...
            <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" SelectMethod="GetProgramAdminFormList"
                TypeName="MyForm">
                <SelectParameters>
                    <asp:ControlParameter ControlID="HiddenField1" DefaultValue="0" Name="ProgramAdminId"

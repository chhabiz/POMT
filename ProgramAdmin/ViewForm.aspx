<%@ Page Title="" Language="C#" MasterPageFile="~/ProgramAdmin/ProgramAdminMaster.master"
    AutoEventWireup="true" CodeBehind="ViewForm.aspx.cs" Inherits="CurriculumMapping.ProgramAdmin.ViewForm" %>

<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="asp" %>
<asp:Content ID="Content2" ContentPlaceHolderID="progadminhead" runat="server">
    <title>View Form - Program Admin</title>
</asp:Content>
    ...
    <div class="maincontent">
        <div id="textcontent">
            <div id="formdata">
                ...
                <asp:Panel ID="pnlHeader5" runat="server">
                    <a href="">
                        Australian Blueprint for Career Development</a>
                </asp:Panel>
        ...
        <div class="commentstab">
            <asp:Panel ID="pnl_ProgramAdmin" runat="server">
                <asp:HyperLink ID="CourseOfferingLink" Target="_self" runat="server" Text="Edit this Form" />
                <br />

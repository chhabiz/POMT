<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMaster.master" AutoEventWireup="true"
    CodeBehind="ManagePAC.aspx.cs" Inherits="CurriculumMapping.Admin.ManagePAC" %>

<%@ Register Assembly="Telerik.Web.UI" Namespace="Telerik.Web.UI" TagPrefix="telerik" %>

<asp:Content ID="Content2" ContentPlaceHolderID="adminhead" runat="server">
    <title>Professional Accreditation Capabilities - Admin</title>
</asp:Content>
    ...
    <div class="maincontent">
        <div id="textcontent">
                                ...
                                <tr>
                                    <td>
                                        <asp:Label ID="ValueLabel" runat="server" AssociatedControlID="InsertTBValue" 
                                            Text="Capability Name"></asp:Label>
                                    </td>
                                    <td>
            ...
            <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" SelectMethod="GetAllSpecificationAttributeOptions"
                ...
                <SelectParameters>
                    <asp:Parameter DefaultValue="10" Name="SpecificationAttribId" Type="Int32" />
                </SelectParameters>
            ...
            <asp:ObjectDataSource ID="ObjectDataSource2" runat="server" SelectMethod="GetManageKVPairs"
                ...
                <SelectParameters>
                    <asp:Parameter DefaultValue="10" Name="SAId" Type="Int32" />
                </SelectParameters>
                <UpdateParameters>

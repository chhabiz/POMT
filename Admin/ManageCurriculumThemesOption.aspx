<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMaster.master" AutoEventWireup="true"
    CodeBehind="ManageCurriculumThemesOption.aspx.cs" Inherits="CurriculumMapping.Admin.ManageCurriculumThemesOption" %>

<%@ Register Assembly="Telerik.Web.UI" Namespace="Telerik.Web.UI" TagPrefix="telerik" %>

<asp:Content ID="Content2" ContentPlaceHolderID="adminhead" runat="server">
    <title>Manage Curriculum Themes - Admin</title>
</asp:Content>
    ...
    <div class="maincontent">
        <div id="textcontent">
                                ...
                                <tr>
                                    <td>
                                        <asp:Label ID="SpecificationAttributeOptionLabel2" runat="server" 
                                            ...
                                            Text="Attribute Option"></asp:Label>
                                    </td>
                                    <td>
                        ...
                        <td colspan="6">
                            <table cellspacing="0" class="rlvEditTable">
                                <tr>
                                    ...
                                    <td>
                                        <%--<asp:TextBox ID="SpecificationAttributeOptionTextBox" runat="server" 
                                            CssClass="rlvInput" Text='<%# Bind("SpecificationAttributeOption.Name") %>' />--%>
            ...
            <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" SelectMethod="GetAllSpecificationAttributeOptions"
                ...
                <SelectParameters>
                    <asp:Parameter DefaultValue="5" Name="SpecificationAttribId" Type="Int32" />
                </SelectParameters>
            ...
            <asp:ObjectDataSource ID="ObjectDataSource2" runat="server" SelectMethod="GetManageKVPairs"
                ...
                <SelectParameters>
                    <asp:Parameter DefaultValue="5" Name="SAId" Type="Int32" />
                </SelectParameters>
                <UpdateParameters>

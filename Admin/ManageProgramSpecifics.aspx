<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMaster.master" AutoEventWireup="true"
    CodeBehind="ManageProgramSpecifics.aspx.cs" Inherits="CurriculumMapping.Admin.ManageProgramSpecifics" %>

<%@ Register Assembly="Telerik.Web.UI" Namespace="Telerik.Web.UI" TagPrefix="telerik" %>

<asp:Content ID="Content2" ContentPlaceHolderID="adminhead" runat="server">
    <title>Manage Program Specific Outcomes - Admin</title>
</asp:Content>
    ...
    <div class="maincontent">
        <div id="textcontent">
                            ...
                            <tfoot>
                                <tr>
                                    ...
                                    <telerik:RadButton ID="AddButton1" runat="server" Visible="True" CommandName="InitInsert"
                                        Text="Add New Program Specific CLO" />
                                </tr>
                            </tfoot>
                            <tbody>
            ...
            <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" SelectMethod="GetAllSpecificationAttributeOptions"
                ...
                <SelectParameters>
                    <asp:Parameter DefaultValue="9" Name="SpecificationAttribId" Type="Int32" />
                </SelectParameters>
            ...
            <asp:ObjectDataSource ID="ObjectDataSource2" runat="server" SelectMethod="GetManageKVPairs"
                ...
                <SelectParameters>
                    <asp:Parameter DefaultValue="9" Name="SAId" Type="Int32" />
                </SelectParameters>
                <UpdateParameters>

<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMaster.master" AutoEventWireup="true"
    CodeBehind="ManageLearningExperienceOption.aspx.cs" Inherits="CurriculumMapping.Admin.ManageLearningExpOption" %>

<%@ Register Assembly="Telerik.Web.UI" Namespace="Telerik.Web.UI" TagPrefix="telerik" %>

<asp:Content ID="Content2" ContentPlaceHolderID="adminhead" runat="server">
    <title>Manage Learning Experiences - Admin</title>
</asp:Content>
    ...
    <div class="maincontent">
        <div id="textcontent">
            ...
            <telerik:RadListView ID="RadListView1" runat="server" DataSourceID="ObjectDataSource2"
                            ...
                            <tfoot>
                                <tr>
                                    ...
                                    <telerik:RadButton ID="AddButton1" runat="server" Visible="True" CommandName="InitInsert"
                                        Text="Add New Learning Experience" />
                                </tr>
                            </tfoot>
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <%--<telerik:RadNumericTextBox ID="IdTextBox" runat="server" DataType="Int32" 
                                            ...
                                            Skin="<%#Container.OwnerListView.Skin %>" Width="155px" />--%>
                                         <asp:Label ID="IdTextBox" runat="server" width="155px" Text='<%#Eval("Id") %>' Enabled="false">
                                         </asp:Label>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <asp:TextBox ID="SpecificationAttributeOptionTextBox" runat="server" 
                                            CssClass="rlvInput" Text='<%# Eval("SpecificationAttributeOption") %>' Enabled="false"
                                            Width="155px" />
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <asp:TextBox ID="ValueTextBox" runat="server" CssClass="rlvInput" 
                                            Text='<%# Bind("Value") %>' Enabled="false" Width="155px" />
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                ...
                <SelectedItemTemplate>
                    <tr class="rlvISel">
                        ...
                        <td>
                            <asp:Label ID="SpecificationAttributeOptionLabel" runat="server" 
                                Text='<%# Eval("SpecificationAttributeOption") %>' />
                        </td>
                        <td>
            ...
            <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" SelectMethod="GetAllSpecificationAttributeOptions"
                ...
                <SelectParameters>
                    <asp:Parameter DefaultValue="4" Name="SpecificationAttribId" Type="Int32" />
                </SelectParameters>
            ...
            <asp:ObjectDataSource ID="ObjectDataSource2" runat="server" SelectMethod="GetManageKVPairs"
                ...
                <SelectParameters>
                    <asp:Parameter DefaultValue="4" Name="SAId" Type="Int32" />
                </SelectParameters>
                <UpdateParameters>

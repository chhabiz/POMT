<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMaster.master" AutoEventWireup="true" CodeBehind="ManageABCDOption.aspx.cs" Inherits="CurriculumMapping.Admin.ManageABCDOption" %>

<%@ Register Assembly="Telerik.Web.UI" Namespace="Telerik.Web.UI" TagPrefix="telerik" %>

<asp:Content ID="Content2" ContentPlaceHolderID="adminhead" runat="server">
    <title>Manage ABCD - Admin</title>
</asp:Content>
    ...
    <div class="maincontent">
        <div id="textcontent">
            ...
            <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" SelectMethod="GetAllSpecificationAttributeOptions"
                ...
                <SelectParameters>
                    <asp:Parameter DefaultValue="7" Name="SpecificationAttribId" Type="Int32" />
                </SelectParameters>
            ...
            <asp:ObjectDataSource ID="ObjectDataSource2" runat="server" SelectMethod="GetManageKVPairs"
                ...
                <SelectParameters>
                    <asp:Parameter DefaultValue="7" Name="SAId" Type="Int32" />
                </SelectParameters>
                <UpdateParameters>

    ...
    public partial class MyPendingForms : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!Page.IsPostBack)
            {
                try
                {
                    ...
                    if (!(userDesignation.Description.Equals("Lecturer")) && !(userDesignation.Description.Equals("Program Manager")) && !(userDesignation.Description.Equals("Administrator")))
                    {
        ...
        public String determineURL(Object statusIdObj, Object OfferingObj, Object TitleString)
        {
            ...
            if (statusId.Equals("C"))
            {
                ...
                URL = "GenerateNewForm.aspx?id=" + offerId + "&C=1&CF="+coffering + "&title=" + titleStr;
            }
            else if (statusId.Equals("E"))
            {
                URL = "GenerateNewForm.aspx?id=" + offerId + "&C=1&CF=" + offerId + "&title=" + titleStr;
            }

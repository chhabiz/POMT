<%@ Page Title="" Language="C#" MasterPageFile="~/SuperAdmin/SuperAdmin.master" AutoEventWireup="true"
    CodeBehind="GenerateReport.aspx.cs" Inherits="CurriculumMapping.Admin.GenerateReport" %>

<%@ Register Assembly="Telerik.Web.UI" Namespace="Telerik.Web.UI" TagPrefix="telerik" %>
<%@ Register Assembly="Telerik.Web.UI" Namespace="Telerik.Charting" TagPrefix="telerik" %>

<asp:Content ID="Content2" ContentPlaceHolderID="superadminhead" runat="server">
    <title>Generate Report - Super Admin</title>
</asp:Content>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentMainArea" runat="server">
    <div class="maincontent">
        <div id="textcontent">
            <div id="reportparams">
                <asp:Label ID="Label3" runat="server" SkinID="SkinLabel">College Name:</asp:Label>
                <telerik:RadComboBox ID="lst_college" runat="server" AutoPostBack="True" OnSelectedIndexChanged="lst_college_SelectedIndexChanged">
                </telerik:RadComboBox>
                <br />
                <asp:Label ID="Label2" runat="server" SkinID="SkinLabel">School Name:</asp:Label>
                <telerik:RadComboBox ID="lst_school" runat="server" AutoPostBack="True" OnSelectedIndexChanged="lst_school_SelectedIndexChanged">
                </telerik:RadComboBox>
                <br />
                ...
                <telerik:RadComboBox ID="lst_archives" runat="server" AutoPostBack="True" OnSelectedIndexChanged="lst_archives_SelectedIndexChanged">
                </telerik:RadComboBox>
                <br />
                <br />
            ...
            <div id="reportcontent">
                ...
                <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" SelectMethod="getReportLOTStatisticsPercentage"
                    ...
                    <SelectParameters>
                        ...
                        <asp:Parameter DefaultValue="ReportLOTStatistics" Name="sprocedureName" Type="String" />
                    </SelectParameters>
                ...
                <asp:ObjectDataSource ID="ObjectDataSource2" runat="server" SelectMethod="getReportLOTStatisticsProp"
                    ...
                    <SelectParameters>
                        ...
                        <asp:ControlParameter ControlID="calYear" DefaultValue="1900" Name="calendarYear"
                            PropertyName="Value" Type="String" />
                        <asp:Parameter DefaultValue="ReportLOTPropStatistics" Name="sprocedureName" Type="String" />
                    </SelectParameters>
                </asp:ObjectDataSource>
                <br />
                ...
                <asp:ObjectDataSource ID="ObjectDataSource3" runat="server" SelectMethod="getReportLOTStatisticsPercentage"
                    ...
                    <SelectParameters>
                        ...
                        <asp:ControlParameter ControlID="calYear" DefaultValue="1900" Name="calendarYear"
                            PropertyName="Value" Type="String" />
                        <asp:Parameter DefaultValue="ReportGAStatistics" Name="sprocedureName" Type="String" />
                    </SelectParameters>
                </asp:ObjectDataSource>
                <br />
                ...
                <asp:ObjectDataSource ID="ObjectDataSource4" runat="server" SelectMethod="getReportLOTStatisticsProp"
                    ...
                    <SelectParameters>
                        ...
                        <asp:ControlParameter ControlID="calYear" DefaultValue="1900" Name="calendarYear"
                            PropertyName="Value" Type="String" />
                        <asp:Parameter DefaultValue="ReportGAPropStatistics" Name="sprocedureName" Type="String" />
                    </SelectParameters>
                </asp:ObjectDataSource>
                <br />
                ...
                <asp:ObjectDataSource ID="ObjectDataSource22" runat="server" SelectMethod="getReportBarChartStatistics"
                    ...
                    <SelectParameters>
                        ...
                        <asp:ControlParameter ControlID="calYear" DefaultValue="1900" Name="calendarYear"
                            PropertyName="Value" Type="String" />
                        <asp:Parameter DefaultValue="ReportLOTBarChartStatistics" Name="sprocedureName" Type="String" />
                    </SelectParameters>
                </asp:ObjectDataSource>
                <br />
                ...
                <asp:ObjectDataSource ID="ObjectDataSource23" runat="server" SelectMethod="getReportBarChartStatistics"
                    ...
                    <SelectParameters>
                        ...
                        <asp:ControlParameter ControlID="calYear" DefaultValue="1900" Name="calendarYear"
                            PropertyName="Value" Type="String" />
                        <asp:Parameter DefaultValue="ReportGABarChartStatistics" Name="sprocedureName" Type="String" />
                    </SelectParameters>
                </asp:ObjectDataSource>
                <br/>
    ...
    <Appearance>
        ...
        <TextAppearance TextProperties-Color="51, 51, 51">
                    ...
                    <ChartTitle>
                        ...
                        <TextBlock Text="Australian Qualification Framework">
                            <Appearance TextProperties-Color="Black" TextProperties-Font="Calibri, 12pt">
                            </Appearance>
                        </TextBlock>
                    </ChartTitle>
                ...
                <asp:ObjectDataSource ID="ObjectDataSource40" runat="server" 
                    SelectMethod="getReportLOTStatisticsPercentage" TypeName="ReportData">
                    <SelectParameters>
                        <asp:ControlParameter ControlID="lst_program" DefaultValue="0" 
                            Name="programCode" PropertyName="SelectedValue" Type="String" />
                        <asp:ControlParameter ControlID="calYear" DefaultValue="1900" Name="calendarYear" 
                            PropertyName="Value" Type="String" />
                        <asp:Parameter DefaultValue="ReportAQFStatistics" Name="sprocedureName" 
                            Type="String" />
                    </SelectParameters>
                </asp:ObjectDataSource>
                <br />
    ...
    <Appearance>
        ...
        <TextAppearance TextProperties-Color="51, 51, 51">
                    ...
                    <ChartTitle>
                        ...
                        <TextBlock Text="Australian Qualification Framework (Weighted)">
                            <Appearance TextProperties-Color="Black" TextProperties-Font="Calibri, 12pt">
                            </Appearance>
                        </TextBlock>
                    </ChartTitle>
                ...
                <asp:ObjectDataSource ID="ObjectDataSource41" runat="server" 
                    ...
                    <SelectParameters>
                        ...
                        <asp:Parameter DefaultValue="ReportAQFPropStatistics" Name="sprocedureName" 
                            Type="String" />
                    </SelectParameters>
                </asp:ObjectDataSource>
                <br />
                ...
                <asp:ObjectDataSource ID="ObjectDataSource42" runat="server" 
                    ...
                    <SelectParameters>
                        ...
                        <asp:ControlParameter ControlID="calYear" DefaultValue="1900" 
                            Name="calendarYear" PropertyName="Value" Type="String" />
                        <asp:Parameter DefaultValue="ReportAQFBarChartStatistics" Name="sprocedureName" 
                            Type="String" />
                    </SelectParameters>
                </asp:ObjectDataSource>
                <br/>

                <telerik:RadChart ID="RadChart43" runat="server" 
        ...
        <TextAppearance TextProperties-Color="51, 51, 51">
                ...
                <asp:ObjectDataSource ID="ObjectDataSource43" runat="server" 
                    ...
                    <SelectParameters>
                        ...
                        <asp:ControlParameter ControlID="calYear" DefaultValue="1900" 
                            Name="calendarYear" PropertyName="Value" Type="String" />
                        <asp:Parameter DefaultValue="ReportPACStatistics" Name="sprocedureName" 
                            Type="String" />
                ...
                <telerik:RadChart ID="RadChart44" runat="server" 
        ...
        <TextAppearance TextProperties-Color="51, 51, 51">
                ...
                <asp:ObjectDataSource ID="ObjectDataSource46" runat="server" 
                    ...
                    <SelectParameters>
                        ...
                        <asp:ControlParameter ControlID="calYear" DefaultValue="1900" 
                            Name="calendarYear" PropertyName="Value" Type="String" />
                        <asp:Parameter DefaultValue="ReportPACPropStatistics" Name="sprocedureName" 
                            Type="String" />
                        <asp:ControlParameter ControlID="hf_pac1" DefaultValue="0" Name="pac" 
                            PropertyName="Value" Type="String" />
                    </SelectParameters>
...
<telerik:ChartSeries Name="Series 2" Type="Pie">
    <Appearance>
        ...
        <Border Color="111, 174, 12" />
                ...
                <br />
                <telerik:RadChart ID="RadChart49" runat="server" DataGroupColumn="YearSemData" 
                ...
                <asp:ObjectDataSource ID="ObjectDataSource49" runat="server" 
                    ...
                    <SelectParameters>
                        ...
                        <asp:ControlParameter ControlID="calYear" DefaultValue="1900" 
                            Name="calendarYear" PropertyName="Value" Type="String" />
                        <asp:Parameter DefaultValue="ReportPACBarChartStatistics" Name="sprocedureName" 
                            Type="String" />
                        <asp:ControlParameter ControlID="hf_pac1" DefaultValue="0" Name="pac" 
                            PropertyName="Value" Type="String" />
                    </SelectParameters>
                ...
                <br/>
                <telerik:RadChart ID="RadChart51" runat="server" 
                ...
                <asp:ObjectDataSource ID="ObjectDataSource5" runat="server" SelectMethod="getReportLOTStatisticsPercentage"
                    ...
                    <SelectParameters>
                        ...
                        <asp:ControlParameter ControlID="calYear" DefaultValue="1900" Name="calendarYear"
                            PropertyName="Value" Type="String" />
                        <asp:Parameter DefaultValue="ReportATTypeStatistics" Name="sprocedureName" Type="String" />
                    </SelectParameters>
                </asp:ObjectDataSource>
                <br />
                ...
                <asp:ObjectDataSource ID="ObjectDataSource6" runat="server" SelectMethod="getReportLOTStatisticsPercentage"
                    ...
                    <SelectParameters>
                        ...
                        <asp:ControlParameter ControlID="calYear" DefaultValue="1900" Name="calendarYear"
                            PropertyName="Value" Type="String" />
                        <asp:Parameter DefaultValue="ReportATMediumStatistics" Name="sprocedureName" Type="String" />
                    </SelectParameters>
                </asp:ObjectDataSource>
                <br />
                ...
                <asp:ObjectDataSource ID="ObjectDataSource7" runat="server" SelectMethod="getReportLOTStatistics"
                    ...
                    <SelectParameters>
                        ...
                        <asp:ControlParameter ControlID="calYear" DefaultValue="1900" Name="calendarYear"
                            PropertyName="Value" Type="String" />
                        <asp:Parameter DefaultValue="ReportATFormatStatistics" Name="sprocedureName" Type="String" />
                    </SelectParameters>
                </asp:ObjectDataSource>
                <br />
                ...
                <asp:ObjectDataSource ID="ObjectDataSource39" runat="server" SelectMethod="getReportLOTStatistics"
                    ...
                    <SelectParameters>
                        ...
                        <asp:ControlParameter ControlID="calYear" DefaultValue="1900" Name="calendarYear"
                            PropertyName="Value" Type="String" />
                        <asp:Parameter DefaultValue="ReportATFormatMultiChoiceStatistics" Name="sprocedureName"
                            Type="String" />
                    </SelectParameters>
                </asp:ObjectDataSource>
                <br />
                ...
                <asp:ObjectDataSource ID="ObjectDataSource8" runat="server" SelectMethod="getReportLOTStatisticsPercentage"
                    ...
                    <SelectParameters>
                        ...
                        <asp:ControlParameter ControlID="calYear" DefaultValue="1900" Name="calendarYear"
                            PropertyName="Value" Type="String" />
                        <asp:Parameter DefaultValue="ReportATRoleStatistics" Name="sprocedureName" Type="String" />
                    </SelectParameters>
                </asp:ObjectDataSource>
                <br />
                ...
                <asp:ObjectDataSource ID="ObjectDataSource9" runat="server" SelectMethod="getReportLOTStatisticsPercentage"
                    ...
                    <SelectParameters>
                        ...
                        <asp:ControlParameter ControlID="calYear" DefaultValue="1900" Name="calendarYear"
                            PropertyName="Value" Type="String" />
                        <asp:Parameter DefaultValue="ReportATAuthenticityStatistics" Name="sprocedureName"
                            Type="String" />
                    </SelectParameters>
                </asp:ObjectDataSource>
                <br />
                ...
                <asp:ObjectDataSource ID="ObjectDataSource10" runat="server" SelectMethod="getReportLOTStatisticsPercentage"
                    ...
                    <SelectParameters>
                        ...
                        <asp:ControlParameter ControlID="calYear" DefaultValue="1900" Name="calendarYear"
                            PropertyName="Value" Type="String" />
                        <asp:Parameter DefaultValue="ReportATSupervisionStatistics" Name="sprocedureName"
                            Type="String" />
                    </SelectParameters>
                </asp:ObjectDataSource>
                <br />
                ...
                <asp:ObjectDataSource ID="ObjectDataSource11" runat="server" SelectMethod="getReportLOTStatisticsPercentage"
                    ...
                    <SelectParameters>
                        ...
                        <asp:ControlParameter ControlID="calYear" DefaultValue="1900" Name="calendarYear"
                            PropertyName="Value" Type="String" />
                        <asp:Parameter DefaultValue="ReportATModeStatistics" Name="sprocedureName" Type="String" />
                    </SelectParameters>
                </asp:ObjectDataSource>
                <br />
                ...
                <asp:ObjectDataSource ID="ObjectDataSource12" runat="server" SelectMethod="getReportLOTStatisticsPercentage"
                    ...
                    <SelectParameters>
                        ...
                        <asp:ControlParameter ControlID="calYear" DefaultValue="1900" Name="calendarYear"
                            PropertyName="Value" Type="String" />
                        <asp:Parameter DefaultValue="ReportATAssessorsStatistics" Name="sprocedureName" Type="String" />
                    </SelectParameters>
                </asp:ObjectDataSource>
                <br />
                ...
                <asp:ObjectDataSource ID="ObjectDataSource13" runat="server" SelectMethod="getReportLOTStatisticsPercentage"
                    ...
                    <SelectParameters>
                        ...
                        <asp:ControlParameter ControlID="calYear" DefaultValue="1900" Name="calendarYear"
                            PropertyName="Value" Type="String" />
                        <asp:Parameter DefaultValue="ReportATPurposeStatistics" Name="sprocedureName" Type="String" />
                    </SelectParameters>
                </asp:ObjectDataSource>
                ...
                <asp:ObjectDataSource ID="ObjectDataSource24" runat="server" SelectMethod="getReportBarChartStatisticsProp"
                    ...
                    <SelectParameters>
                        ...
                        <asp:ControlParameter ControlID="calYear" DefaultValue="1900" Name="calendarYear"
                            PropertyName="Value" Type="String" />
                        <asp:Parameter DefaultValue="ReportATDueWeekBarChartStatistics" Name="sprocedureName"
                            Type="String" />
                    </SelectParameters>
                </asp:ObjectDataSource>
                <br />
                ...
                <asp:ObjectDataSource ID="ObjectDataSource25" runat="server" SelectMethod="getReportBarChartStatisticsProp"
                    ...
                    <SelectParameters>
                        ...
                        <asp:ControlParameter ControlID="calYear" DefaultValue="1900" Name="calendarYear"
                            PropertyName="Value" Type="String" />
                        <asp:Parameter DefaultValue="ReportATY1S1BarChartStatistics" Name="sprocedureName"
                            Type="String" />
                    </SelectParameters>
                </asp:ObjectDataSource>
                <br />
                ...
                <asp:ObjectDataSource ID="ObjectDataSource26" runat="server" SelectMethod="getReportBarChartStatisticsProp"
                    ...
                    <SelectParameters>
                        ...
                        <asp:ControlParameter ControlID="calYear" DefaultValue="1900" Name="calendarYear"
                            PropertyName="Value" Type="String" />
                        <asp:Parameter DefaultValue="ReportATY1S2BarChartStatistics" Name="sprocedureName"
                            Type="String" />
                    </SelectParameters>
                </asp:ObjectDataSource>
                <br />
                ...
                <asp:ObjectDataSource ID="ObjectDataSource27" runat="server" SelectMethod="getReportBarChartStatisticsProp"
                    ...
                    <SelectParameters>
                        ...
                        <asp:ControlParameter ControlID="calYear" DefaultValue="1900" Name="calendarYear"
                            PropertyName="Value" Type="String" />
                        <asp:Parameter DefaultValue="ReportATY2S1BarChartStatistics" Name="sprocedureName"
                            Type="String" />
                    </SelectParameters>
                </asp:ObjectDataSource>
                <br />
                ...
                <asp:ObjectDataSource ID="ObjectDataSource28" runat="server" SelectMethod="getReportBarChartStatisticsProp"
                    ...
                    <SelectParameters>
                        ...
                        <asp:ControlParameter ControlID="calYear" DefaultValue="1900" Name="calendarYear"
                            PropertyName="Value" Type="String" />
                        <asp:Parameter DefaultValue="ReportATY2S2BarChartStatistics" Name="sprocedureName"
                            Type="String" />
                    </SelectParameters>
                </asp:ObjectDataSource>
                <br />
                ...
                <asp:ObjectDataSource ID="ObjectDataSource29" runat="server" SelectMethod="getReportBarChartStatisticsProp"
                    ...
                    <SelectParameters>
                        ...
                        <asp:ControlParameter ControlID="calYear" DefaultValue="1900" Name="calendarYear"
                            PropertyName="Value" Type="String" />
                        <asp:Parameter DefaultValue="ReportATY3S1BarChartStatistics" Name="sprocedureName"
                            Type="String" />
                    </SelectParameters>
                </asp:ObjectDataSource>
                <br />
                ...
                <asp:ObjectDataSource ID="ObjectDataSource30" runat="server" SelectMethod="getReportBarChartStatisticsProp"
                    ...
                    <SelectParameters>
                        ...
                        <asp:ControlParameter ControlID="calYear" DefaultValue="1900" Name="calendarYear"
                            PropertyName="Value" Type="String" />
                        <asp:Parameter DefaultValue="ReportATY3S2BarChartStatistics" Name="sprocedureName"
                            Type="String" />
                    </SelectParameters>
                </asp:ObjectDataSource>
                <br />
                ...
                <asp:ObjectDataSource ID="ObjectDataSource31" runat="server" SelectMethod="getReportBarChartStatisticsProp"
                    ...
                    <SelectParameters>
                        ...
                        <asp:ControlParameter ControlID="calYear" DefaultValue="1900" Name="calendarYear"
                            PropertyName="Value" Type="String" />
                        <asp:Parameter DefaultValue="ReportATY4S1BarChartStatistics" Name="sprocedureName"
                            Type="String" />
                    </SelectParameters>
                </asp:ObjectDataSource>
                <br />
                ...
                <asp:ObjectDataSource ID="ObjectDataSource32" runat="server" SelectMethod="getReportBarChartStatisticsProp"
                    ...
                    <SelectParameters>
                        ...
                        <asp:ControlParameter ControlID="calYear" DefaultValue="1900" Name="calendarYear"
                            PropertyName="Value" Type="String" />
                        <asp:Parameter DefaultValue="ReportATY4S2BarChartStatistics" Name="sprocedureName"
                            Type="String" />
                    </SelectParameters>
                </asp:ObjectDataSource>
                <br />
                ...
                <asp:ObjectDataSource ID="ObjectDataSource33" runat="server" SelectMethod="getReportBarChartStatisticsProp"
                    ...
                    <SelectParameters>
                        ...
                        <asp:ControlParameter ControlID="calYear" DefaultValue="1900" Name="calendarYear"
                            PropertyName="Value" Type="String" />
                        <asp:Parameter DefaultValue="ReportATY5S1BarChartStatistics" Name="sprocedureName"
                            Type="String" />
                    </SelectParameters>
                </asp:ObjectDataSource>
                <br />
                ...
                <asp:ObjectDataSource ID="ObjectDataSource34" runat="server" SelectMethod="getReportBarChartStatisticsProp"
                    ...
                    <SelectParameters>
                        ...
                        <asp:ControlParameter ControlID="calYear" DefaultValue="1900" Name="calendarYear"
                            PropertyName="Value" Type="String" />
                        <asp:Parameter DefaultValue="ReportATY5S2BarChartStatistics" Name="sprocedureName"
                            Type="String" />
                    </SelectParameters>
                </asp:ObjectDataSource>
                <br />
                ...
                <asp:ObjectDataSource ID="ObjectDataSource35" runat="server" SelectMethod="getReportBarChartStatisticsProp"
                    ...
                    <SelectParameters>
                        ...
                        <asp:ControlParameter ControlID="calYear" DefaultValue="1900" Name="calendarYear"
                            PropertyName="Value" Type="String" />
                        <asp:Parameter DefaultValue="ReportATY6S1BarChartStatistics" Name="sprocedureName"
                            Type="String" />
                    </SelectParameters>
                </asp:ObjectDataSource>
                <br />
                ...
                <asp:ObjectDataSource ID="ObjectDataSource36" runat="server" SelectMethod="getReportBarChartStatisticsProp"
                    ...
                    <SelectParameters>
                        ...
                        <asp:ControlParameter ControlID="calYear" DefaultValue="1900" Name="calendarYear"
                            PropertyName="Value" Type="String" />
                        <asp:Parameter DefaultValue="ReportATY6S2BarChartStatistics" Name="sprocedureName"
                            Type="String" />
                    </SelectParameters>
                </asp:ObjectDataSource>
                <br />
                ...
                <asp:ObjectDataSource ID="ObjectDataSource14" runat="server" SelectMethod="getReportLOTStatisticsPercentage"
                    ...
                    <SelectParameters>
                        ...
                        <asp:ControlParameter ControlID="calYear" DefaultValue="1900" Name="calendarYear"
                            PropertyName="Value" Type="String" />
                        <asp:Parameter DefaultValue="ReportLETuitionPatternStatistics" Name="sprocedureName"
                            Type="String" />
                    </SelectParameters>
                </asp:ObjectDataSource>
                <br />
                ...
                <asp:ObjectDataSource ID="ObjectDataSource15" runat="server" SelectMethod="getReportLOTStatisticsPercentage"
                    ...
                    <SelectParameters>
                        ...
                        <asp:ControlParameter ControlID="calYear" DefaultValue="1900" Name="calendarYear"
                            PropertyName="Value" Type="String" />
                        <asp:Parameter DefaultValue="ReportLEDurationStatistics" Name="sprocedureName" Type="String" />
                    </SelectParameters>
                </asp:ObjectDataSource>
                <br />
                ...
                <asp:ObjectDataSource ID="ObjectDataSource16" runat="server" SelectMethod="getReportLOTStatisticsPercentage"
                    ...
                    <SelectParameters>
                        ...
                        <asp:ControlParameter ControlID="calYear" DefaultValue="1900" Name="calendarYear"
                            PropertyName="Value" Type="String" />
                        <asp:Parameter DefaultValue="ReportLEFreqStatistics" Name="sprocedureName" Type="String" />
                    </SelectParameters>
                </asp:ObjectDataSource>
                <br />
                ...
                <asp:ObjectDataSource ID="ObjectDataSource17" runat="server" SelectMethod="getReportLOTStatisticsPercentage"
                    ...
                    <SelectParameters>
                        ...
                        <asp:ControlParameter ControlID="calYear" DefaultValue="1900" Name="calendarYear"
                            PropertyName="Value" Type="String" />
                        <asp:Parameter DefaultValue="ReportLEStudentActStatistics" Name="sprocedureName"
                            Type="String" />
                    </SelectParameters>
                </asp:ObjectDataSource>
                <br />
                ...
                <asp:ObjectDataSource ID="ObjectDataSource18" runat="server" SelectMethod="getReportLOTStatisticsPercentage"
                    ...
                    <SelectParameters>
                        ...
                        <asp:ControlParameter ControlID="calYear" DefaultValue="1900" Name="calendarYear"
                            PropertyName="Value" Type="String" />
                        <asp:Parameter DefaultValue="ReportLRResourceStatistics" Name="sprocedureName" Type="String" />
                    </SelectParameters>
                </asp:ObjectDataSource>
                <br />
                ...
                <asp:ObjectDataSource ID="ObjectDataSource19" runat="server" SelectMethod="getReportLOTStatisticsPercentage"
                    ...
                    <SelectParameters>
                        ...
                        <asp:ControlParameter ControlID="calYear" DefaultValue="1900" Name="calendarYear"
                            PropertyName="Value" Type="String" />
                        <asp:Parameter DefaultValue="ReportLRFreqUseStatistics" Name="sprocedureName" Type="String" />
                    </SelectParameters>
                </asp:ObjectDataSource>
                <br />
                ...
                <asp:ObjectDataSource ID="ObjectDataSource20" runat="server" SelectMethod="getReportLOTStatisticsPercentage"
                    ...
                    <SelectParameters>
                        ...
                        <asp:ControlParameter ControlID="calYear" DefaultValue="1900" Name="calendarYear"
                            PropertyName="Value" Type="String" />
                        <asp:Parameter DefaultValue="ReportLRCostStudentStatistics" Name="sprocedureName"
                            Type="String" />
                    </SelectParameters>
                </asp:ObjectDataSource>
                <br />
                ...
                <asp:ObjectDataSource ID="ObjectDataSource21" runat="server" SelectMethod="getReportLOTStatisticsPercentage"
                    ...
                    <SelectParameters>
                        ...
                        <asp:ControlParameter ControlID="calYear" DefaultValue="1900" Name="calendarYear"
                            PropertyName="Value" Type="String" />
                        <asp:Parameter DefaultValue="ReportTILevelStatistics" Name="sprocedureName" Type="String" />
                    </SelectParameters>
                </asp:ObjectDataSource>
                <br />
                ...
                <asp:ObjectDataSource ID="ObjectDataSource37" runat="server" SelectMethod="getReportTripleIBarChartStatistics"
                    ...
                    <SelectParameters>
                        ...
                        <asp:ControlParameter ControlID="calYear" DefaultValue="1900" Name="calendarYear"
                            PropertyName="Value" Type="String" />
                        <asp:Parameter DefaultValue="ReportTIBarChartStatistics" Name="sprocedureName" Type="String" />
                    </SelectParameters>
                </asp:ObjectDataSource>
                <br />
                ...
                <asp:ObjectDataSource ID="ObjectDataSource38" runat="server" SelectMethod="getReportABCDBarChartStatistics"
                    ...
                    <SelectParameters>
                        ...
                        <asp:ControlParameter ControlID="calYear" DefaultValue="1900" Name="calendarYear"
                            PropertyName="Value" Type="String" />
                        <asp:Parameter DefaultValue="ReportABCDBarChartStatistics" Name="sprocedureName"
                            Type="String" />
                    </SelectParameters>
                </asp:ObjectDataSource>
                <br />
